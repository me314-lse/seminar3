...
We will create a simulation function that draws repeated random samples from the population and calculates the sample mean for each. 
...
Now, run the simulation with the following combinations of inputs (16 total): 

- n_sims, the number of samples: 5, 100, 1000, 10000
- sample_size, the number of rolls per sample: 5, 10, 30, 100

And visualise the results as a 4 x 4 plot of histograms (16 total histograms).
